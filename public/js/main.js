    ...
    var capsula = {
        ...
        rangeSlider: function () {
            $('.tm-rangeslider').nstSlider({
                ...
                'value_changed_callback': function (cause, leftValue, rightValue) {
                    ...
                    $(this).parent().find('.tm-rangeslider-mininput').val(leftValue);
                    $(this).parent().find('.tm-rangeslider-maxinput').val(rightValue);
                }
            });
        },
        ...
        productRatingInput: function () {
            $('.tm-ratingbox-input').each(function () {
                $(this).find('span').on('mouseenter', function () {
                    ...
                    var count = 5 - $(this).nextAll('span').length;
        ...
        loginPassShower: function () {
            $('input[name="register-pass-show"]').on('change', function () {
                var type = $('input[name="register_password"]').attr('type');
                if (type == 'password') {
                    $('input[name="register_password"]').attr('type', 'text');
                    $('input[name="register_password_confirmation"]').attr('type', 'text');
                } else {
                    $('input[name="register_password"]').attr('type', 'password');
                    $('input[name="register_password_confirmation"]').attr('type', 'password');
                }
            });
        },
        ...
        /* All Initialization */
        init: function () {
            capsula.headerOptionsDropdown();
            capsula.databgImage();
            capsula.meanmenuActivation();
            capsula.niceSelectActive();
            capsula.countdownActivation();
            capsula.sliderActivations.init();
            capsula.fancyboxSlick();
            capsula.ajaxMailchimp();
            capsula.stickyHeader();
            capsula.scrollToTop();
            capsula.herosliderHeight();
            capsula.rangeSlider();
            capsula.productRatingInput();
            capsula.productQuantityBox();
            //capsula.instafeedActive();
            capsula.scrollAnimation();
            capsula.differentAddressFormToggle();
            capsula.checkoutPaymentMethod();
            capsula.loginPassShower();
            capsula.menuOverflow();
            capsula.dropdownHasChildren();
            capsula.ajaxContactForm();
            capsula.portfolioFilter();
            capsula.productChangeView();
        }
    }
